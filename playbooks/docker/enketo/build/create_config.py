...
def create_config():
    ...
    config = {
        ...
        'logo': {
          "source": os.environ.get("ENKETO_LOGO_SOURCE","https://i1.wp.com/bluesquarehub.com/wp-content/uploads/2019/11/Bluesquare-horizontal-white.png?w=200&ssl=1"),
        },
        ...
        "redis": {
            "main": {
                "host": to_host(os.getenv('ENKETO_REDIS_MAIN_URL',"redis_main")),
                "port": 6379
            },
            "cache": {
                'host': to_host(os.getenv('ENKETO_REDIS_CACHE_URL','redis_cache')),
                "port": 6379
            }
        }
    }
